...
namespace Noodle.Localization.Tests
{
    ...
    public class LocalizationServiceTests : LocalizationTestsBase
    {
        ...
        public void Can_get_resource_from_default_language()
        {
            ...
            var localizationSetting = _kernel.Resolve<IConfigurationProvider<LocalizationSettings>>();
            ...
            // act
            var value = _kernel.Resolve<ILocalizationService>().GetResource("test default");
