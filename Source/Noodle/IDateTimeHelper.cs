...
namespace Noodle
{
    ...
    public interface IDateTimeHelper
    {
        ...
        /// <summary>
        /// Converts the date and time from the source to the destination
        /// </summary>
        ...
        DateTime ConvertToTimeZone(DateTime dt, TimeZoneInfo sourceTimeZone, TimeZoneInfo destinationTimeZone);
